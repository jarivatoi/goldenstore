        ...
        <div className="mb-2 sm:mb-3">
          ...
          <div className="flex justify-center mb-2 relative">
            <div className="relative">
              ...
              {/* Bottle and Crate Badge - midway between circle border and card end */}
              {hasReturnables && totalReturnablesCount > 0 && (
                <div
                  ...
                  style={{
                    top: '-8px',
                    left: '50%',
                    transform: 'translateX(72px)', // Midway: 48px (circle edge) + 24px (half of remaining space to card edge)
                    zIndex: 10
                  }}
                >
                  {/* Bottle and count - centered */}
                  <div className="flex flex-col items-center gap-0.5 relative" style={{ zIndex: 11 }}>
                    <span className="font-bold text-orange-600 text-center whitespace-nowrap" style={{
                      fontSize: '14px'
                    }}>
                  ...
                  {/* Crate positioned below bottle - centered on bottle */}
                  {totalCratesCount > 0 && (
              ...
              {/* Crate only (when no bottles) - midway between circle border and card end */}
              {hasReturnables && totalReturnablesCount === 0 && totalCratesCount > 0 && (
                ...
                >
                  {/* Invisible placeholder to maintain same DOM structure */}
                  ...
                  {/* Crate positioned below - centered */}
                  <div className="absolute" style={{
                    top: '18px',
                    left: '50%',
                    transform: 'translateX(-50%)'
        ...
        <div className="text-xs sm:text-sm text-gray-500 min-h-[3.5rem] flex flex-col justify-end">
          {returnableItemsText.length > 0 ? (
            <div className="mb-2 flex items-center">
              <ScrollingText
                key={`${client.id}-${returnableItemsText.length}-${forceUpdate}`}
