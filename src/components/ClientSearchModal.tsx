...
const ClientSearchModal: React.FC<ClientSearchModalProps> = ({ 
  ...
  const modalContent = (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-[9999] overflow-hidden select-none" style={{ height: '100vh' }}>
      <div className="bg-white rounded-xl shadow-lg w-full max-w-lg max-h-[80vh] overflow-hidden select-none">
        ...
        {/* Content */}
        <div className="p-6 overflow-y-auto select-none" style={{ maxHeight: 'calc(80vh - 120px)' }}>
