...
const ClientSearchModal: React.FC<ClientSearchModalProps> = ({ 
  ...
  const handleClose = () => {
    // Preserve calculator state and client link when going back
    // Don't clear any calculator state or call onResetCalculator
    onClose();
  };
  ...
  const modalContent = (
    ...
    >
      <div 
        className="bg-white rounded-xl shadow-lg w-full max-w-lg max-h-[90vh] overflow-hidden select-none"
        style={{
      ...
      >
        ...
        {/* Header */}
        <div className="flex justify-between items-center p-6 border-b border-gray-200 bg-yellow-200 select-none">
        ...
        <div className="p-6 overflow-y-auto flex-1 select-none">
            ...
            <div className="p-3 bg-gray-50 rounded-lg border border-gray-200 select-none">
              ...
              <div className="grid grid-cols-6 gap-2 mb-2 select-none">
                ...
                <button
                  ...
                  className="px-3 py-2 bg-green-500 hover:bg-green-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white border border-green-500 rounded font-medium transition-colors text-sm select-none flex items-center justify-center"
          ...
          <div className="mb-4 select-none">
            ...
            <div className="grid grid-cols-3 gap-2 mb-3 select-none">
              {['Foodstuffs', 'Cig', 'Rum', 'Can', 'Soft Drinks', 'Cakes', 'Chopine', 'Bouteille', '1L Bouteille', '1.5L Bouteille', '0.5L', '1L', '1.5L', '2L', 'Juice'].map((action) => (
                <button
                  key={action}
                  type="button"
