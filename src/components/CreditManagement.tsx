        ...
        <div className="w-full lg:w-80 bg-white rounded-lg shadow-lg p-4 lg:p-6 order-1 lg:order-2 flex flex-col">
          ...
          <div className="mb-4">
            <div className="bg-black rounded-lg p-4 mb-2">
              ...
              <div className="text-2xl sm:text-3xl font-mono text-green-400 min-h-[3rem] flex items-center justify-between overflow-hidden bg-black rounded px-3 py-2 relative">
          ...
          <div className="grid grid-cols-6 gap-1 sm:gap-2 mb-6 p-2 sm:p-4 bg-gray-200 rounded-lg border-2 border-gray-400 shadow-inner">
            ...
            <button
              ...
              className="bg-yellow-500 hover:bg-yellow-600 text-white p-2 sm:p-3 rounded-lg font-bold text-xs sm:text-sm shadow-md border border-yellow-600 flex items-center justify-center"
            >
              CE
            </button>
            <button
