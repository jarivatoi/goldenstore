...
const IndependentCalculator: React.FC = () => {
  ...
  const renderFormattedValue = (value: string) => {
    console.log('🎯 renderFormattedValue received:', value);
  ...
  return (
    <div className="w-full lg:w-[32rem] calculator-container-landscape bg-white rounded-lg shadow-lg p-4 lg:p-6 flex flex-col">
      ...
      {/* Calculator Display */}
      <div className="mb-4">
        <div className="bg-black rounded-lg p-4 mb-2 relative">
          {/* Main Display */}
          ...
          {/* Secondary Display - with counter on same line */}
          <div className="text-xs text-gray-400 font-mono mt-1 flex items-center justify-center gap-2">
            {/* Article Count Circle - Same line as READY text */}
            {displayStepInfo && displayStepInfo.currentStep > 0 && (
              <div className="bg-blue-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-xs font-bold">
