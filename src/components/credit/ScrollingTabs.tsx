        ...
        >
          ...
          >
            {sortedClients.map((client, index) => {
              ...
              const shouldShowAnimation = recentlyUpdatedClient === 'any-client-updated' || recentlyUpdatedClient === client.id;
                  ...
                  className={`flex-shrink-0 px-4 py-2 rounded-lg border cursor-pointer h-25 w-40 flex items-center ${
                    ...
                    clickedTabId === client.id 
                      ...
                      : (() => {
                          ...
                          return hasUnreturnedItems && !shouldShowAnimation ? 'animate-subtle-shake' : '';
                        })()
                  }`}
                  style={{
                    userSelect: 'none',
