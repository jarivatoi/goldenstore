        ...
        <div className="flex items-center gap-3 select-none">
          ...
          <div className="relative flex-1 select-none">
            ...
            <input
              ...
              className="block w-full h-[72px] pl-12 pr-1 text-xl border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-3 focus:ring-blue-500 focus:border-blue-500 shadow-sm"
            />
          </div>
